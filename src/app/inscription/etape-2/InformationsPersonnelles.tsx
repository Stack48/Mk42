...
export default function InformationsPersonnelles() {
  ...
  useEffect(() => {
    ...
    const profil = typeof window !== 'undefined' ? sessionStorage.getItem('opus_profile') : null
    router.push(profil === 'particulier' ? '/inscription/etape-4' : '/inscription/etape-3')
  }, [isSignedIn, router])

  const [form, setForm] = useState({
    nom: '', prenom: '', email: '', telephone: '', fonction: '', motDePasse: '', confirmation: '',
  })
        ...
        <div className={styles.layout}>
          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            <div className={styles.fieldGrid}>
              ...
              <div className={styles.field}>
                ...
                <input id="nom" type="text" className={styles.input} value={form.nom} onChange={set('nom')} required autoComplete="family-name" />
              </div>
              ...
              <div className={styles.field}>
                ...
                <input id="prenom" type="text" className={styles.input} value={form.prenom} onChange={set('prenom')} required autoComplete="given-name" />
              </div>
              ...
              <div className={styles.field}>
                ...
                <input id="telephone" type="tel" className={styles.input} value={form.telephone} onChange={set('telephone')} required autoComplete="tel" />
              </div>

              <div className={styles.field}>
                <label htmlFor="fonction" className={styles.label}>Fonction (Optionnel)</label>
                <select id="fonction" className={styles.select} value={form.fonction} onChange={set('fonction')}>
              ...
              <div className={styles.field}>
                ...
                <div className={styles.inputWrapper}>
                  <input id="motDePasse" type={showPassword ? 'text' : 'password'} className={styles.input} value={form.motDePasse} onChange={set('motDePasse')} required autoComplete="new-password" />
                  <button type="button" className={styles.eyeBtn} onClick={() => setShowPassword(v => !v)} aria-label={showPassword ? 'Masquer le mot de passe' : 'Afficher le mot de passe'}>
              ...
              <div className={styles.field}>
                ...
                <div className={styles.inputWrapper}>
                  <input id="confirmation" type={showConfirm ? 'text' : 'password'} className={styles.input} value={form.confirmation} onChange={set('confirmation')} required autoComplete="new-password" />
            ...
            <div className={styles.formFooter}>
              <button type="button" className={styles.btnPrev} onClick={() => router.push('/inscription')}>
                Précédent
              </button>
              <button type="submit" className={styles.btnNext} disabled={chargement}>
          ...
          <aside className={styles.sidebar} aria-label="Progression de l'inscription">
            ...
            <ol className={styles.stepsList}>
              {STEPS_LIST.map(step => (
                <li key={step.num} className={`${styles.stepItem} ${styles[step.status]}`}>
